...
# @DESCRIPTION:
# Minimum vala API version (e.g. 0.42).
VALA_MIN_API_VERSION=${VALA_MIN_API_VERSION:-0.42}

# @ECLASS-VARIABLE: VALA_MAX_API_VERSION
# @DESCRIPTION:
# Maximum vala API version (e.g. 0.58).
VALA_MAX_API_VERSION=${VALA_MAX_API_VERSION:-0.58}
